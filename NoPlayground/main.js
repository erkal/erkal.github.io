...
var $author$project$NoPlayground$Main$init = function (_v0) {
...
var $author$project$NoPlayground$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$NoPlayground$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onAnimationFrame($author$project$NoPlayground$Main$Tick);
};
...
var $author$project$NoPlayground$Main$update = F2(
	function (msg, model) {
		var posix = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$NoPlayground$Main$view = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$String$fromInt(
							$elm$time$Time$posixToMillis(model.time)) + ' ms')
					]))
			]));
};
var $author$project$NoPlayground$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$NoPlayground$Main$init,
		subscriptions: $author$project$NoPlayground$Main$subscriptions,
		update: $author$project$NoPlayground$Main$update,
		view: A2($elm$core$Basics$composeR, $author$project$NoPlayground$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
_Platform_export({'NoPlayground':{'Main':{'init':$author$project$NoPlayground$Main$main(
