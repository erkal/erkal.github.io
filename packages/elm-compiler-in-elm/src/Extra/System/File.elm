...
writeFile filePath contents =
    walkFileSystem False (filePath |> Debug.log "FilePath in writeFile!") <|
        \maybeNode now ->
            case maybeNode of
                Just ( _, _, Just ( _, DirectoryEntry _ ) ) ->
                ...
                Just ( directory, fileName, _ ) ->
                    ( Just (Map.insert fileName ( now, FileEntry (contents |> Debug.log "Zo!") ) directory), () )
                        |> Debug.log "Zip!"
