...
var $author$project$DesignSystemShowcase$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$DesignSystemShowcase$Main$init,
		subscriptions: $author$project$DesignSystemShowcase$Main$subscriptions,
		update: $author$project$DesignSystemShowcase$Main$update,
		view: A2($elm$core$Basics$composeR, $author$project$DesignSystemShowcase$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
