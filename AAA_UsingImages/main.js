				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Css$url('./assets/canvas-background.jpg')),
							A2(
...
var $author$project$AAA_UsingImages$Main$main = $author$project$Play$simpleApplication(
	{hasTape: false, init: $author$project$AAA_UsingImages$Main$init, initialConfigurations: $author$project$AAA_UsingImages$Main$initialConfigurations, update: $author$project$AAA_UsingImages$Main$update, view: $author$project$AAA_UsingImages$Main$view});
