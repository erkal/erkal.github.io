...
var $author$project$UndoRedo$Main$UndoRedoUsual = {$: 'UndoRedoUsual'};
...
var $author$project$UndoRedo$Main$init = function (computer) {
	return {lastSelectedInteractive: $author$project$UndoRedo$Main$UndoRedoUsual, undoListSafe: $author$project$UndoRedo$Main$undoListExample, undoListSafeConcise: $author$project$UndoRedo$Main$undoListExample, undoListUsual: $author$project$UndoRedo$Main$undoListExample};
};
			...
			switch (interactiveID.$) {
				case 'UndoRedoUsual':
					return _Utils_update(
						model,
						{
							undoListUsual: A2($author$project$UndoRedo$UndoList$new, str, model.undoListUsual)
						});
				case 'UndoRedoSafe':
					return _Utils_update(
						model,
						{
							undoListSafe: A2($author$project$UndoRedo$UndoList$newSafe, str, model.undoListSafe)
						});
				default:
					return _Utils_update(
						model,
						{
							undoListSafeConcise: A2($author$project$UndoRedo$UndoList$newSafeConcise, str, model.undoListSafeConcise)
						});
			}
		} else {
			return model;
		...
		switch (interactiveID.$) {
			case 'UndoRedoUsual':
				return _Utils_update(
					model,
					{
						undoListUsual: f(model.undoListUsual)
					});
			case 'UndoRedoSafe':
				return _Utils_update(
					model,
					{
						undoListSafe: f(model.undoListSafe)
					});
			default:
				return _Utils_update(
					model,
					{
						undoListSafeConcise: f(model.undoListSafeConcise)
					});
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$member, 'KeyZ', computer.keyboard.downs)
			]));
};
...
var $author$project$UndoRedo$UndoList$redo = function (undoList) {
	var past = undoList.past;
	var present = undoList.present;
	var future = undoList.future;
	if (!future.b) {
		return undoList;
	} else {
		var x = future.a;
...
var $author$project$UndoRedo$Main$handleKeyboardShortcutsForUndoRedo = F2(
	function (computer, model) {
		return $author$project$UndoRedo$Main$pressedKeyboardShortcutForUndo(computer) ? A3($author$project$UndoRedo$Main$mapUndoList, $author$project$UndoRedo$UndoList$undo, model.lastSelectedInteractive, model) : ($author$project$UndoRedo$Main$pressedKeyboardShortcutForRedo(computer) ? A3($author$project$UndoRedo$Main$mapUndoList, $author$project$UndoRedo$UndoList$redo, model.lastSelectedInteractive, model) : model);
	});
...
var $author$project$UndoRedo$Main$handleResetButton = F2(
	function (msg, model) {
		if (msg.$ === 'PressedResetInteractiveButton') {
			var interactiveID = msg.a;
			return A3(
...
var $author$project$UndoRedo$Main$UndoRedoSafe = {$: 'UndoRedoSafe'};
var $author$project$UndoRedo$Main$UndoRedoSafeConcise = {$: 'UndoRedoSafeConcise'};
...
var $author$project$UndoRedo$Main$NoOp = {$: 'NoOp'};
...
var $rtfeldman$elm_css$Css$disc = {listStyleType: $rtfeldman$elm_css$Css$Structure$Compatible, listStyleTypeOrPositionOrImage: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'disc'};
...
var $author$project$DesignSystem$buttonWithIcon = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$title(name),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$width(
...
var $author$project$UndoRedo$Main$PressedUndoButton = function (a) {
	return {$: 'PressedUndoButton', a: a};
};
var $author$project$UndoRedo$Main$viewButtons = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								icon: $author$project$Icons$icons.undo,
								name: 'Undo',
								onClick: $author$project$UndoRedo$Main$PressedUndoButton(interactiveID)
							}),
							$author$project$DesignSystem$buttonWithIcon(
							{
								icon: $author$project$Icons$icons.redo,
								name: 'Redo',
								onClick: $author$project$UndoRedo$Main$PressedRedoButton(interactiveID)
							})
						]))
				]));
	});
var $author$project$UndoRedo$Main$EditedTextArea = F2(
	function (a, b) {
		return {$: 'EditedTextArea', a: a, b: b};
	});
var $author$project$UndoRedo$Main$viewInputArea = F2(
	function (model, interactiveID) {
		return $author$project$DesignSystem$textInput(
			{
				name: '',
				onChange: $author$project$UndoRedo$Main$EditedTextArea(interactiveID),
				value: function () {
					switch (interactiveID.$) {
						case 'UndoRedoUsual':
							return model.undoListUsual.present;
						case 'UndoRedoSafe':
							return model.undoListSafe.present;
						default:
							return model.undoListSafeConcise.present;
					}
				}()
			});
	});
...
var $author$project$UndoRedo$Main$viewUndoList = F2(
	function (model, interactiveID) {
		var undoList = function () {
			switch (interactiveID.$) {
				case 'UndoRedoUsual':
					return model.undoListUsual;
				case 'UndoRedoSafe':
					return model.undoListSafe;
				default:
					return model.undoListSafeConcise;
			}
		}();
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$elm$core$List$reverse(undoList.past))),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$author$project$UndoRedo$Main$viewUndoItem(undoList.present)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					A2($elm$core$List$map, $author$project$UndoRedo$Main$viewUndoItem, undoList.future))
				]));
	});
var $author$project$UndoRedo$Main$viewUndoListInteractive = F2(
	function (model, interactiveID) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									$author$project$DesignSystem$buttonWithIcon(
									{
										icon: $author$project$Icons$icons.reset,
										name: 'Reset',
										onClick: $author$project$UndoRedo$Main$PressedResetInteractiveButton(interactiveID)
									})
								]))
						])),
					A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$row),
											A2($rtfeldman$elm_css$Css$property, 'gap', '4rem')
										]))
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($author$project$UndoRedo$Main$viewButtons, model, interactiveID),
									$author$project$DesignSystem$markdownBlock('And edit your `state`:'),
									A2($author$project$UndoRedo$Main$viewInputArea, model, interactiveID)
								])),
							A2($author$project$UndoRedo$Main$viewUndoList, model, interactiveID)
						]))
				]));
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Attributes$href('https://bsky.app/profile/azizerkalselman.bsky.social'),
										$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank'),
										$rtfeldman$elm_css$Html$Styled$Attributes$title('Bluesky')
									]),
								_List_fromArray(
									[$author$project$Icons$icons.blueskyLogo])),
								A2(
								$rtfeldman$elm_css$Html$Styled$a,
								_List_fromArray(
									[
	...
	function (computer, model) {
		return $author$project$DesignSystem$withHomePageHeader(
			A2(
				...
				_List_fromArray(
					[
						$author$project$UndoRedo$Main$txt1,
						A2($author$project$UndoRedo$Main$viewUndoListInteractive, model, $author$project$UndoRedo$Main$UndoRedoUsual),
						$author$project$UndoRedo$Main$txt2,
						A2($author$project$UndoRedo$Main$viewUndoListInteractive, model, $author$project$UndoRedo$Main$UndoRedoSafe),
						$author$project$UndoRedo$Main$txt3,
						A2($author$project$UndoRedo$Main$viewUndoListInteractive, model, $author$project$UndoRedo$Main$UndoRedoSafeConcise),
						$author$project$UndoRedo$Main$txt4
					])));
	});
var $author$project$UndoRedo$Main$main = $author$project$Play$simpleApplication(
	{hasTape: false, init: $author$project$UndoRedo$Main$init, initialConfigurations: _List_Nil, update: $author$project$UndoRedo$Main$update, view: $author$project$UndoRedo$Main$view});
